# language: hu
Jellemző: Felhasználói jelszó kezelése

  Forgatókönyv: Sikeres regisztráció
    Amennyiben új regisztrációt kezdeményezek
    Majd sikeresen azonosítom magam megbízható személyazonosítási módszerrel
    És megadom egy megfelelő email címemet
    És megadok egy megfelelő és egyedi felhasználói azonosítót magamnak
    És kezdeményezem a regisztráció befejezését
    Akkor a rendszer jelzi a sikeres regisztrációt és a további tudnivalókat
  ...
  Forgatókönyv: Sikertelen bejelentkezés
    Amennyiben rendelkezem érvényes regisztrációval
    Majd kezdeményezem a bejelentkezést
    És rosszul adom meg a felhasználói azonosítómat és/vagy az állandó jelszavamat
