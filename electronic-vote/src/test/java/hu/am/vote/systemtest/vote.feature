# language: hu
Jellemző: Elektronikus szavazás

  Háttér:
    Amennyiben folyamatban van a választás

  Forgatókönyv: Sikeres elektronikus szavazás
  ...
  Forgatókönyv: Sikertelen beazonosítás
    Amennyiben elmegyek szavazni
  ...
  Forgatókönyv: Kérdésenként csak egyet választhatok
    Amennyiben elmegyek szavazni
    És sikeresen azonosítom magam
    Majd megkapom a körzetemnek megfelelő kérdőívet
    Akkor kérdésenként csak egyet választhatok

  Forgatókönyv: Félbehagyott szavazás utáni szavazás
    Amennyiben elmegyek szavazni
    És sikeresen azonosítom magam
    Majd félbehagyom a szavazást
    Akkor még szavazhatok

  Forgatókönyv: Fiatal vagyok és nem szavazhatok
    Amennyiben elmegyek szavazni
    És sikeresen azonosítom magam
    De fiatal vagyok
